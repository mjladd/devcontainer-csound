# 07 D. READING MIDI FILES - Code Example 1

## Metadata

- **Source:** FLOSS Manual for Csound
- **Chapter:** 07-d-reading-midi-files
- **Section:** 07 D. READING MIDI FILES
...
This code example is from the FLOSS Manual chapter "07 D. READING MIDI FILES".
See the full chapter for detailed explanation and context.

**Full chapter:** [corpus/floss_manual/chapters/07-d-reading-midi-files.md](../chapters/07-d-reading-midi-files.md)
