# HOW TO: PRINT - Code Example 1

## Metadata

- **Source:** FLOSS Manual for Csound
- **Chapter:** 02-e-print
- **Section:** Which format specifiers can I use?
...
This code example is from the FLOSS Manual chapter "HOW TO: PRINT".
See the full chapter for detailed explanation and context.

**Full chapter:** [corpus/floss_manual/chapters/02-e-print.md](../chapters/02-e-print.md)
