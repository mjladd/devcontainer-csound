...
category: Widgets
file: examples/Widgets/button.csd
title: "Start Synth"
type: cabbage_example
widgets: [form, button, texteditor]
---

# Start Synth

**Category:** Widgets
**Source File:** `examples/Widgets/button.csd`
**Cabbage Widgets:** form, button, texteditor

## Description

Initialize the global variables. Rory Walsh 2021
