...
category: Widgets
file: examples/Widgets/groupbox.csd
title: "ADSR Envelope"
type: cabbage_example
widgets: [form, groupbox, rslider, texteditor, keyboard]
---

# ADSR Envelope

**Category:** Widgets
**Source File:** `examples/Widgets/groupbox.csd`
**Cabbage Widgets:** form, groupbox, rslider, texteditor, keyboard
