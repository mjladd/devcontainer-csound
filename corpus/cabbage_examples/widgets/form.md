...
category: Widgets
file: examples/Widgets/form.csd
title: "form"
type: cabbage_example
widgets: [form, texteditor]
---

# form

**Category:** Widgets
**Source File:** `examples/Widgets/form.csd`
**Cabbage Widgets:** form, texteditor

## Description

Initialize the global variables. Rory Walsh 2021 License: CC0 1.0 Universal You can copy, modify, and distribute this file, even for commercial purposes, all without asking permission.
