...
category: Widgets
file: examples/Miscellaneous/ModifyingWidgetAppearance.csd
title: "X Pos."
type: cabbage_example
widgets: [form, image, hslider, label, vslider, combobox, groupbox, texteditor]
---

# X Pos.

**Category:** Widgets
**Source File:** `examples/Miscellaneous/ModifyingWidgetAppearance.csd`
**Cabbage Widgets:** form, image, hslider, label, vslider, combobox, groupbox, texteditor

## Description

ModifyingWidgetAppearance.csd Written by Iain McCurdy, 2014 Updated to use cabbageGet/Set opcodes Rory Walsh, 2021 An example that demonstrates the ability to modify various attributes of a widget's appearance in realtime from within the Csound orchestra via Cabbage's own widgets.
