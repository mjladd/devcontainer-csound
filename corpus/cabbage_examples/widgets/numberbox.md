...
category: Widgets
file: examples/Widgets/numberbox.csd
title: "Play"
type: cabbage_example
widgets: [form, texteditor, image, button, nslider, rslider]
---

# Play

**Category:** Widgets
**Source File:** `examples/Widgets/numberbox.csd`
**Cabbage Widgets:** form, texteditor, image, button, nslider, rslider
