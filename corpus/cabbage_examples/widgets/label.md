...
category: Widgets
file: examples/Widgets/label.csd
title: "LABELS WILL BE LABELS"
type: cabbage_example
widgets: [form, texteditor, label]
---

# LABELS WILL BE LABELS

**Category:** Widgets
**Source File:** `examples/Widgets/label.csd`
**Cabbage Widgets:** form, texteditor, label

## Description

Initialize the global variables. Rory Walsh 2021 License: CC0 1.0 Universal You can copy, modify, and distribute this file,
