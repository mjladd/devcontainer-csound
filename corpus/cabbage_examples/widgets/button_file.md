...
category: Widgets
file: examples/Widgets/button_file.csd
title: "Load Sample"
type: cabbage_example
widgets: [form, filebutton, button, texteditor, soundfiler, label]
---

# Load Sample

**Category:** Widgets
**Source File:** `examples/Widgets/button_file.csd`
**Cabbage Widgets:** form, filebutton, button, texteditor, soundfiler, label
