...
category: Utilities
file: examples/Utilities/Spectrogram.csd
title: "Display Gain"
type: cabbage_example
widgets: [form, signaldisplay, rslider, label, combobox, image]
---

# Display Gain

**Category:** Utilities
**Source File:** `examples/Utilities/Spectrogram.csd`
**Cabbage Widgets:** form, signaldisplay, rslider, label, combobox, image

## Description

SPECTROGRAM SETTINGS rslider       bounds(570, 20, 70, 90), channel("period"), text("Period"), range(0.01, 0.5, 0.01,1,0.01), valueTextBox(1), fontColour("White"), textColour("White") SOUND SOURCE PARAMETERS
