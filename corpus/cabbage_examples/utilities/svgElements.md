...
category: Utilities
file: examples/Miscellaneous/svgElements.csd
title: "svgElements"
...
**Category:** Utilities
**Source File:** `examples/Miscellaneous/svgElements.csd`
**Cabbage Widgets:** form, image

## Description

first image acts as bounding box - next images as handles first image acts as bounding box - next as handle for curve Initialize the global variables.
