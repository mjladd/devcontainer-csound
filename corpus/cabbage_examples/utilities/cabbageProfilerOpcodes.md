...
category: Utilities
file: examples/Miscellaneous/cabbageProfilerOpcodes.csd
title: "cabbageProfilerOpcodes"
type: cabbage_example
widgets: [form]
---

# cabbageProfilerOpcodes

**Category:** Utilities
**Source File:** `examples/Miscellaneous/cabbageProfilerOpcodes.csd`
**Cabbage Widgets:** form

## Description

Initialize the global variables. create profile with label 'p1' and test block 'oscil' stop block 'oscil' test
