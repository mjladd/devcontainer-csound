...
category: Utilities
file: examples/Miscellaneous/FileRecord.csd
title: "Record to disk"
type: cabbage_example
widgets: [form, button, label]
---

# Record to disk

**Category:** Utilities
**Source File:** `examples/Miscellaneous/FileRecord.csd`
**Cabbage Widgets:** form, button, label

## Description

Initialize the global variables. instrument will be triggered by keyboard widget
