...
category: Utilities
file: examples/Miscellaneous/RealtimeScoreEvents.csd
title: "Enter a score event for instrument 2 or 3..."
type: cabbage_example
widgets: [form, label, texteditor, button, csoundoutput]
---

# Enter a score event for instrument 2 or 3...

**Category:** Utilities
**Source File:** `examples/Miscellaneous/RealtimeScoreEvents.csd`
**Cabbage Widgets:** form, label, texteditor, button, csoundoutput
