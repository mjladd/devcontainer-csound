...
category: Utilities
file: examples/Utilities/Log_Curves.csd
title: "1. log"
type: cabbage_example
widgets: [form, gentable, label, image, combobox, nslider]
---

# 1. log

**Category:** Utilities
**Source File:** `examples/Utilities/Log_Curves.csd`
**Cabbage Widgets:** form, gentable, label, image, combobox, nslider

## Description

Log_Curves.csd Iain McCurdy, 2015
