...
category: Utilities
file: examples/Miscellaneous/CompressSidechain.csd
title: "Attack"
type: cabbage_example
widgets: [form, image, rslider, hrange, label]
---

# Attack

**Category:** Utilities
**Source File:** `examples/Miscellaneous/CompressSidechain.csd`
**Cabbage Widgets:** form, image, rslider, hrange, label
