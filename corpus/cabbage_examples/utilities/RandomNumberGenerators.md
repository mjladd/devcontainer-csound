...
category: Utilities
file: examples/Utilities/RandomNumberGenerators.csd
title: "Rate of Updates"
type: cabbage_example
widgets: [form, image, gentable, nslider, button, checkbox, label, rslider, combobox]
---

# Rate of Updates

**Category:** Utilities
**Source File:** `examples/Utilities/RandomNumberGenerators.csd`
**Cabbage Widgets:** form, image, gentable, nslider, button, checkbox, label, rslider, combobox

## Description

RandomNumberGenerators.csd Written by Iain McCurdy 2015 Demonstration of the following opcodes for generating contiguous random functions: randomi randomh rspline jspline jitter jitter2 vibr vibrato gaussi trandom"), channel("Type") Running minimum and maximum values are logged. It will be noticed that rspline can output values beyond the maximum allowed amplitude limits (-1 and 1) The functions can be sonified through how they vary the frequency of an sine wave oscillator
