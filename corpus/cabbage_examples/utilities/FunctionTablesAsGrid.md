...
category: Utilities
file: examples/Miscellaneous/FunctionTablesAsGrid.csd
title: "BPM"
type: cabbage_example
widgets: [form, gentable, rslider, image]
---

# BPM

**Category:** Utilities
**Source File:** `examples/Miscellaneous/FunctionTablesAsGrid.csd`
**Cabbage Widgets:** form, gentable, rslider, image

## Description

sr is set by the host RW 2014 ---------------------------------------- main instrument
