...
category: Utilities
file: examples/Miscellaneous/PresetsChannels.csd
title: "Att."
type: cabbage_example
widgets: [form, keyboard, rslider, combobox, button]
---

# Att.

**Category:** Utilities
**Source File:** `examples/Miscellaneous/PresetsChannels.csd`
**Cabbage Widgets:** form, keyboard, rslider, combobox, button
