...
category: Utilities
file: examples/Miscellaneous/Euclidean.csd
title: "Hits"
type: cabbage_example
widgets: [form, image, rslider, checkbox, nslider, label, hslider, button]
---

# Hits

**Category:** Utilities
**Source File:** `examples/Miscellaneous/Euclidean.csd`
**Cabbage Widgets:** form, image, rslider, checkbox, nslider, label, hslider, button

## Description

controls for clock 1 controls for clock 2
