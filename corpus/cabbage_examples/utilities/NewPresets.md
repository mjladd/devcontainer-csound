...
category: Utilities
file: examples/Miscellaneous/NewPresets.csd
title: "Att."
type: cabbage_example
widgets: [form, csoundoutput, keyboard, rslider, presetbutton, label, button]
---

# Att.

**Category:** Utilities
**Source File:** `examples/Miscellaneous/NewPresets.csd`
**Cabbage Widgets:** form, csoundoutput, keyboard, rslider, presetbutton, label, button

## Description

Initialize the global variables. sr is set by the host
