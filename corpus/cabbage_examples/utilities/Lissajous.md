...
category: Utilities
file: examples/Utilities/Lissajous.csd
title: "Period"
type: cabbage_example
widgets: [form, image, gentable, signaldisplay, rslider, button, checkbox, label, vslider, listbox]
---

# Period

**Category:** Utilities
**Source File:** `examples/Utilities/Lissajous.csd`
**Cabbage Widgets:** form, image, gentable, signaldisplay, rslider, button, checkbox, label, vslider, listbox

## Description

Lissajous Iain McCurdy 2023 Uses signaldisplay widget to display Lissajous patterns Lissagous patterns are created by sending different waveforms to the X and Y inputs of an oscilloscope. In a normal oscilloscope the X input is simply a phase pointer. In this example, the audio output is the multiplication (ring modulation) of the two input audio signals. DISPLAY CONTROLS Period   - time period over which the curve is drawn X Scale  - display scaling of X input, audio level unaffected
