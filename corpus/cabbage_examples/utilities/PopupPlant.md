...
category: Utilities
file: examples/Miscellaneous/PopupPlant.csd
title: "Popup Plant"
type: cabbage_example
widgets: [form, groupbox, rslider, button]
---

# Popup Plant

**Category:** Utilities
**Source File:** `examples/Miscellaneous/PopupPlant.csd`
**Cabbage Widgets:** form, groupbox, rslider, button
