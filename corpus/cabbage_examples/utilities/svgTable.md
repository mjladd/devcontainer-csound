...
category: Utilities
file: examples/Miscellaneous/svgTable.csd
title: "Draw Table"
type: cabbage_example
widgets: [form, image, button, hslider, label]
---

# Draw Table

**Category:** Utilities
**Source File:** `examples/Miscellaneous/svgTable.csd`
**Cabbage Widgets:** form, image, button, hslider, label
