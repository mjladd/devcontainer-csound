...
category: Utilities
file: examples/Miscellaneous/KnobManSliders.csd
title: "Rotary Sliders"
type: cabbage_example
widgets: [form, groupbox, rslider, vslider, hslider]
---

# Rotary Sliders

**Category:** Utilities
**Source File:** `examples/Miscellaneous/KnobManSliders.csd`
**Cabbage Widgets:** form, groupbox, rslider, vslider, hslider
