...
category: Utilities
file: examples/Miscellaneous/cabbageChanged.csd
title: "Most recently changed widget:"
type: cabbage_example
widgets: [form, rslider, combobox, label]
---

# Most recently changed widget:

**Category:** Utilities
**Source File:** `examples/Miscellaneous/cabbageChanged.csd`
**Cabbage Widgets:** form, rslider, combobox, label

## Description

Cabbage example instrument.
