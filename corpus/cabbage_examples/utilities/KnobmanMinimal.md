...
category: Utilities
file: examples/Miscellaneous/KnobmanMinimal.csd
title: "Filmstrip Sliders"
type: cabbage_example
widgets: [form, groupbox, rslider]
---

# Filmstrip Sliders

**Category:** Utilities
**Source File:** `examples/Miscellaneous/KnobmanMinimal.csd`
**Cabbage Widgets:** form, groupbox, rslider
