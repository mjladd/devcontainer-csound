...
category: Utilities
file: examples/Miscellaneous/MouseSense.csd
title: "MOUSE X"
type: cabbage_example
widgets: [form, nslider, texteditor]
---

# MOUSE X

**Category:** Utilities
**Source File:** `examples/Miscellaneous/MouseSense.csd`
**Cabbage Widgets:** form, nslider, texteditor

## Description

MouseSense.csd Written by Iain McCurdy, 2014
