...
category: Utilities
file: examples/Miscellaneous/SampleLoadAndPlayback.csd
title: "Open sample folder"
type: cabbage_example
widgets: [form, soundfiler, keyboard, filebutton, label]
---

# Open sample folder

**Category:** Utilities
**Source File:** `examples/Miscellaneous/SampleLoadAndPlayback.csd`
**Cabbage Widgets:** form, soundfiler, keyboard, filebutton, label
