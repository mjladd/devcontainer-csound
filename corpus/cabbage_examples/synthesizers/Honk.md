...
file: examples/Instruments/PhysicalModelling/Honk.csd
title: "Input"
type: cabbage_example
widgets: [form, image, label, rslider, hslider, line, keyboard]
---

# Input

**Category:** Synthesizers
**Source File:** `examples/Instruments/PhysicalModelling/Honk.csd`
**Cabbage Widgets:** form, image, label, rslider, hslider, line, keyboard

## Description

Honk.csd Written by Iain McCurdy, 2014 Instrument based on the wgbowedbar opcode (bowed bar). As with many physical modelling opcodes the results can be unpredicatable sometimes resulting in silence and at other times resulting in overloading. I have endeavoured to protect against overloads. Controller ranges have been tuned to provide the most interesting results but extensive experimentation is still recommended. Input (Amplitude) ----------------- This controls the amplitude of vibrations cau
