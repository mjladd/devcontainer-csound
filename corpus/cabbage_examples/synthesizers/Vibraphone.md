...
file: examples/Instruments/Physical Modelling/Vibraphone.csd
title: "V  I  B  R  A  T  O"
...
**Category:** Synthesizers
**Source File:** `examples/Instruments/Physical Modelling/Vibraphone.csd`
**Cabbage Widgets:** form, image, label, rslider, keyboard

## Description

Vibraphone (physical model) Iain McCurdy. 2019 CONTROLS V  I  B  R  A  T  O Vibrato    - depth and speed of vibrato (also controllable using MIDI modulation wheel Depth      - depth of vibrato Rate       - rate of vibrato M  A  L  L  E  T Hardness   - hardness of the beater
