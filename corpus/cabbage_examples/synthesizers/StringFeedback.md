...
file: examples/Instruments/PhysicalModelling/StringFeedback.csd
title: "String"
type: cabbage_example
widgets: [form, groupbox, rslider, checkbox, keyboard, hslider]
---

# String

**Category:** Synthesizers
**Source File:** `examples/Instruments/PhysicalModelling/StringFeedback.csd`
**Cabbage Widgets:** form, groupbox, rslider, checkbox, keyboard, hslider

## Description

StringFeedback.csd - an emulation of a feeding back vibrating string Written by Iain McCurdy, 2013 ------------------ String --------- Feedback -   signal that is fed back into the vibrating string model. If a particular note doesn't sound, boost this! Drive    -   overdrive level (on each individual string, so no interference sidebands will be produced when chords are played, see 'Gain' in the 'Output' section for this effect) Sustain  -   sustain of the string vibrations. Inverse of damping. B
