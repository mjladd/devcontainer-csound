...
file: examples/Instruments/PhysicalModelling/Clavinet.csd
title: "Brilliant"
type: cabbage_example
widgets: [form, image, checkbox, button, groupbox, rslider, line, label, combobox, keyboard]
---

# Brilliant

**Category:** Synthesizers
**Source File:** `examples/Instruments/PhysicalModelling/Clavinet.csd`
**Cabbage Widgets:** form, image, checkbox, button, groupbox, rslider, line, label, combobox, keyboard

## Description

Clavinet.csd - an emulation of the Hohner Clavinet D6 ----------------------------------------------------- Pickup Selection ---------------- CA - neck pickup only (pickup A) CB - bridge pickup only (pickup B) DA - both pickups in phase DB - bridge pickup (pickup B) 180 degrees out of phase w.r.t the neck pickup Setup ----- Pick A - position of the first pickup (range 0 - 1). Typically referred to as the 'neck' pickup
