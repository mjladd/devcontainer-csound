...
file: examples/Instruments/PhysicalModelling/Strum.csd
title: "Notes"
type: cabbage_example
widgets: [form, image, xypad, rslider, checkbox]
---

# Notes

**Category:** Synthesizers
**Source File:** `examples/Instruments/PhysicalModelling/Strum.csd`
**Cabbage Widgets:** form, image, xypad, rslider, checkbox

## Description

Strum.csd Written by Iain McCurdy, 2014 A moving xypad pointer plucks imaginary strings stretched across its surface. Movement in the y direction therefore controls pitch. Movement in the x direction varies pluck position and panning location. Notes        -    number of notes/strings/subdivisions triggered along the y-axis of the xypad Spacing     -    spacing between adjacent notes in semitones or fractions thereof Offset    -    global note offset (note number) Shift        -    shift in semi
