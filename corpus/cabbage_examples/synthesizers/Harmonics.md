...
file: examples/Instruments/PhysicalModelling/Harmonics.csd
title: "A M P L I T U D E"
type: cabbage_example
widgets: [form, image, label, rslider, combobox, checkbox, line, vslider, keyboard]
---

# A M P L I T U D E

**Category:** Synthesizers
**Source File:** `examples/Instruments/PhysicalModelling/Harmonics.csd`
**Cabbage Widgets:** form, image, label, rslider, combobox, checkbox, line, vslider, keyboard

## Description

Harmonics.csd Written by Iain McCurdy, 2014 Emulation of a piano string-hammer mechanism with a damping node placed some way along the string to force harmonic overtones Each note played triggers two strings, which can be detuned with respect to each other. As well as emulating the hammer striking the string in the first place, a release hammer (or string damping mechanism is emulated) AMPLITUDE Amp.        -    Global amplitude control Vel.        -    key velocity influence upon hammer amplitu
