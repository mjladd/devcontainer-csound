...
file: examples/Instruments/Physical Modelling/Mellotron MkII Flute.csd
title: "C R A C K L E"
type: cabbage_example
widgets: [form, keyboard, image, label, rslider, checkbox]
---

# C R A C K L E

**Category:** Synthesizers
**Source File:** `examples/Instruments/Physical Modelling/Mellotron MkII Flute.csd`
**Cabbage Widgets:** form, keyboard, image, label, rslider, checkbox

## Description

Mellotron Mk.II Flute Iain McCurdy. 2019 A semi-physical model of a Mellotron MkII flute sound. Emulations of noise, hum, crackle and tape Wow are implemented CONTROLS Volume - as its name suggests Tone   - 6 dB/oct lowpass filter Pitch  - pitch control of the flute sound +/- 2 semitones. Can also be controlled using a MIDI pitch bend wheel.
