...
file: examples/GEN/GEN09.csd
title: "P.N.1"
type: cabbage_example
widgets: [form, gentable, rslider, nslider, checkbox, label, combobox, button, keyboard]
---

# P.N.1

**Category:** Synthesizers
**Source File:** `examples/GEN/GEN09.csd`
**Cabbage Widgets:** form, gentable, rslider, nslider, checkbox, label, combobox, button, keyboard

## Description

GEN09.csd Written by Iain McCurdy "P.N.1-8"     sets the partial number for each of the 8 partials. Note that "Base" and "Int" will also have an influence upon the partial number values. "Str.1-8"     sets the strengths for the 8 partials. "Mute 1-8"    allow the user to mute individual partials "Solo 1-8"    allow the user to solo individual partials (multiple solos can be employed) "Ph.1-8"      sets the initial phases (in degrees) for the 8 partials. "Base"        sets a base offset (integer)
