...
file: examples/Instruments/Miscellaneous/PendulumWaves.csd
title: "Time"
type: cabbage_example
widgets: [form, image, nslider, checkbox, button, label, filebutton, combobox, gentable]
---

# Time

**Category:** Synthesizers
**Source File:** `examples/Instruments/Miscellaneous/PendulumWaves.csd`
**Cabbage Widgets:** form, image, nslider, checkbox, button, label, filebutton, combobox, gentable

## Description

Pendulum Waves Emulation of popular harmonic pendulum waves Note events are triggered by the 12 pendulum bobs as they cross the vertical line. Most controls arre adjusted using number boxes. You can adjust these by either clicking and dragging on them or by clicking then typing a new number on them, the latter is probably easier. Time         - an indicator of elapsed time (for this to represent seconds, Speed must be set to '1') Play/Pause   - start and stop the pendulums Hold Pattern - this wi
