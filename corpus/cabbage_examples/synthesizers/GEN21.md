...
file: examples/GEN/GEN21.csd
title: "Uniform [pos.]"
type: cabbage_example
widgets: [form, gentable, combobox, checkbox, rslider]
---

# Uniform [pos.]

**Category:** Synthesizers
**Source File:** `examples/GEN/GEN21.csd`
**Cabbage Widgets:** form, gentable, combobox, checkbox, rslider

## Description

GEN21.csd Written by Iain McCurdy demonstration of the GEN21 opcode, used to create various random distributions changing the value given for giTabSize (in instrument header area) and the value for 'drawmode' (part of the table widget) can change the appearance of the distribution. display is set between -1 and 1. Certain distributions may require reduction of the 'level' control in order for them to be fully displayed
