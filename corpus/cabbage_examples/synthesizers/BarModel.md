...
file: examples/Instruments/PhysicalModelling/BarModel.csd
title: "Boundary Conditions"
type: cabbage_example
widgets: [form, label, combobox, checkbox, rslider, button, image, groupbox, gentable, line]
---

# Boundary Conditions

**Category:** Synthesizers
**Source File:** `examples/Instruments/PhysicalModelling/BarModel.csd`
**Cabbage Widgets:** form, label, combobox, checkbox, rslider, button, image, groupbox, gentable, line

## Description

BarModel.csd Original physical model code by Stefan Bilbao, ported to Csound by John ffitch Example written by Iain McCurdy, 2015 Uses barmodel physical model of a struck bar Note that some tuning anomalies may exist. These are due to rounding errors in the algorithm and are largely unresolvable. On account of this instrument being based upon a fairly complex physical modelling algorithm, it will be unreasonable to expect massive polyphony in realtime. For this reason a polyphony control mechani
