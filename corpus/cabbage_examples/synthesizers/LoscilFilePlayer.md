...
file: examples/FilePlayers/LoscilFilePlayer.csd
title: "Open File"
type: cabbage_example
widgets: [form, image, soundfiler, filebutton, checkbox, label, combobox, rslider, line, keyboard]
---

# Open File

**Category:** Synthesizers
**Source File:** `examples/FilePlayers/LoscilFilePlayer.csd`
**Cabbage Widgets:** form, image, soundfiler, filebutton, checkbox, label, combobox, rslider, line, keyboard

## Description

LoscilFilePlayer.csd Written by Iain McCurdy, 2014 Load a user selected sound file into a GEN 01 function table and plays it back using loscil3. This file player is best suited for polyphonic playback and is less well suited for the playback of very long sound files . The sound file can be played back using the Play/Stop button (and the 'Transpose' / 'Speed' buttons to implement pitch/speed change) or it can be played back using the MIDI keyboard. The loop points can be set either by using the l
