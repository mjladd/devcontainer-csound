...
file: examples/Instruments/Synths/Arpeggiator.csd
title: "Arpeggiator"
type: cabbage_example
widgets: [form, groupbox, rslider, label, combobox, checkbox, button, line, keyboard, infobutton]
---

# Arpeggiator

**Category:** Synthesizers
**Source File:** `examples/Instruments/Synths/Arpeggiator.csd`
**Cabbage Widgets:** form, groupbox, rslider, label, combobox, checkbox, button, line, keyboard, infobutton

## Description

Arpeggiator.csd Written by Iain McCurdy, 2012 Arpeggiator This instrument implements an arpeggiator effect, such as is often found on hardware synthesizers. The notes generated by the arpeggiator are played by a simple synthesizer and echoed by a multi-mode delay. Arpeggiator Section Interval     -   sets the interval, in semitones, of transposition steps applied to the sequence when repeated cyclically. Cycles       -   adds repeats of the entire arpeggio transposed sequentially by the number o
