...
file: examples/Instruments/DrumMachines/DrumPads.csd
title: "DrumPads"
...
**Category:** Synthesizers
**Source File:** `examples/Instruments/DrumMachines/DrumPads.csd`
**Cabbage Widgets:** form, image

## Description

Each pad triggers a different synthesised sound based on the Roland 808 Horizontal position across the pad controls the pan location. This is grabbed at the beginning of the note only. Vertical position up the pad controls the velocity (amplitude). This is grabbed at the beginning of the note only.
