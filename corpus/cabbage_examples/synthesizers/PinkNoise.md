...
file: examples/Instruments/Noise/PinkNoise.csd
title: "On/Off"
type: cabbage_example
widgets: [form, image, checkbox, combobox, rslider]
---

# On/Off

**Category:** Synthesizers
**Source File:** `examples/Instruments/Noise/PinkNoise.csd`
**Cabbage Widgets:** form, image, checkbox, combobox, rslider

## Description

PinkNoise.csd Written by Iain McCurdy, 2012
