...
file: examples/Instruments/Noise/FractalNoise.csd
title: "On/Off"
type: cabbage_example
widgets: [form, image, checkbox, label, rslider, gentable]
---

# On/Off

**Category:** Synthesizers
**Source File:** `examples/Instruments/Noise/FractalNoise.csd`
**Cabbage Widgets:** form, image, checkbox, label, rslider, gentable

## Description

FractalNoise.csd Written by Iain McCurdy, 2015 GUI colour indicates noise type: 'white' - 'pink' - 'brown'
