...
file: examples/Instruments/Synths/CZSynth.csd
title: ". PHASE DISTORTION ."
type: cabbage_example
widgets: [form, image, label, rslider, checkbox, combobox, button, keyboard]
---

# . PHASE DISTORTION .

**Category:** Synthesizers
**Source File:** `examples/Instruments/Synths/CZSynth.csd`
**Cabbage Widgets:** form, image, label, rslider, checkbox, combobox, button, keyboard

## Description

CZSynth.csd Iain McCurdy, 2015 CZSynth employs phase distortion synthesis, a technique featured in Casio's CZ range of synthesisers from the 1980s This synth can create strident lead sounds and if higher partials are employed with high levels of phase distortion aliasing can occur. This is left in as a chacteristic of the instrument but if desired, raising the sample rate can reduce or prevent this aliasing The basic waveform (before phase distortion) can be designed in one of three ways: Additi
