...
file: examples/Instruments/Synths/gbuzz_synth.csd
title: ".  M  A  I  N  ."
type: cabbage_example
widgets: [form, image, label, rslider, combobox, checkbox, button, keyboard]
---

# .  M  A  I  N  .

**Category:** Synthesizers
**Source File:** `examples/Instruments/Synths/gbuzz_synth.csd`
**Cabbage Widgets:** form, image, label, rslider, combobox, checkbox, button, keyboard

## Description

gbuzz synth Iain McCurdy 2014 MAIN - control of the harmonics contained within the basic tone POLYPHONY - polyphonic/monophonic switching and portamento settings for monophonic mode PITCH BEND - response to MIDI pitch bend changed MULTIPLIER ENVELOPE - envelope that modulates the spectral emphasis of the sound LOW CUT - a highpass (low-cut) filter which moves according to the note played
