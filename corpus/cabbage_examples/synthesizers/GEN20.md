...
file: examples/GEN/GEN20.csd
title: "Hamming"
type: cabbage_example
widgets: [form, gentable, combobox, hslider, label, checkbox, image, nslider]
---

# Hamming

**Category:** Synthesizers
**Source File:** `examples/GEN/GEN20.csd`
**Cabbage Widgets:** form, gentable, combobox, hslider, label, checkbox, image, nslider

## Description

GEN20.csd Written by Iain McCurdy, 2014
