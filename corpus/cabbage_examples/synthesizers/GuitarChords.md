...
file: examples/Instruments/PhysicalModelling/GuitarChords.csd
title: "Mute"
type: cabbage_example
widgets: [form, label, combobox, checkbox, image, line, button, hslider, filebutton]
---

# Mute

**Category:** Synthesizers
**Source File:** `examples/Instruments/PhysicalModelling/GuitarChords.csd`
**Cabbage Widgets:** form, label, combobox, checkbox, image, line, button, hslider, filebutton

## Description

GuitarChords.csd Written by Iain McCurdy, 2012.
