...
file: examples/GEN/GEN08_Envelopes.csd
title: "3 Break-point Envelope"
type: cabbage_example
widgets: [form, gentable, label, nslider, image, checkbox, combobox, hslider, keyboard]
---

# 3 Break-point Envelope

**Category:** Synthesizers
**Source File:** `examples/GEN/GEN08_Envelopes.csd`
**Cabbage Widgets:** form, gentable, label, nslider, image, checkbox, combobox, hslider, keyboard

## Description

GEN08_Envelopes.csd Written by Iain McCurdy, 2015. A method of editing GEN08 function tables by clicking and dragging breakpoints. GEN08 generates function tables by drawing the smoothest possible curve between defined breakpoints. Note that this can often result in the function extending well above the highest breakpoint or well below the lowest breakpoint. In the example when the functions are used as amplitude envelopes they are clipped at zero and 1 to prevent out of range amplitudes. It is
