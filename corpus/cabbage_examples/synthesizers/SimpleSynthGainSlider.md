...
file: examples/Miscellaneous/SimpleSynthGainSlider.csd
title: "SimpleSynthGainSlider"
type: cabbage_example
widgets: [form, hslider, keyboard]
---

# SimpleSynthGainSlider

**Category:** Synthesizers
**Source File:** `examples/Miscellaneous/SimpleSynthGainSlider.csd`
**Cabbage Widgets:** form, hslider, keyboard
