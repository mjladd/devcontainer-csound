...
file: examples/Instruments/PhysicalModelling/PreparedPiano.csd
title: "Num.Strings"
type: cabbage_example
widgets: [form, nslider, label, checkbox, combobox, image, keyboard]
---

# Num.Strings

**Category:** Synthesizers
**Source File:** `examples/Instruments/PhysicalModelling/PreparedPiano.csd`
**Cabbage Widgets:** form, nslider, label, checkbox, combobox, image, keyboard

## Description

PreparedPiano.csd Written by Iain McCurdy, 2016 This instrument is an encapsulation of the 'prepiano' opcode, an emulation of a prepared piano string modified with a damping piece of rubber and a rattling element (e.g. a bolt) in loose contact with the string. This physical model emplys complex mathematics and therefore places a high demand upon the CPU. It will be unrealistic to expect more that a few notes of polyphony being possible. Increasing the 'Num.Strings' paramter increases the CPU dem
