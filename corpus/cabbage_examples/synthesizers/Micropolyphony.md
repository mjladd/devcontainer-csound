...
file: examples/Instruments/Miscellaneous/Micropolyphony.csd
title: "MONO/POLY"
type: cabbage_example
widgets: [form, image, label, button, rslider, combobox, checkbox, hslider, keyboard, vslider]
---

# MONO/POLY

**Category:** Synthesizers
**Source File:** `examples/Instruments/Miscellaneous/Micropolyphony.csd`
**Cabbage Widgets:** form, image, label, button, rslider, combobox, checkbox, hslider, keyboard, vslider

## Description

Micropolyphony.csd Written by Iain McCurdy, 2016 The main intention behind this instrument was to explore the techniques of tone clusters and micropolyphony, - as used by composers such as György Ligeti and Krzysztof Penderecki. Note that on account of integer rounding, wgbow may not always sound 'in tune' across the length of the keyboard. Other synth engines are offered which won't present this problem CONTROLS -------- [MONO/POLY]
