...
file: examples/Instruments/Synths/HardSyncSynth.csd
title: "W a v e f o r m"
type: cabbage_example
widgets: [form, image, label, combobox, gentable, checkbox, rslider, hslider, button, keyboard]
---

# W a v e f o r m

**Category:** Synthesizers
**Source File:** `examples/Instruments/Synths/HardSyncSynth.csd`
**Cabbage Widgets:** form, image, label, combobox, gentable, checkbox, rslider, hslider, button, keyboard

## Description

HardSync.csd Written by Iain McCurdy 2016 This is an implementation of hard sync between two oscillators Two oscillators are established, one is referred to as the master and the other as the slave. The slave oscillator reads a waveform, the shape of which is chosen by the user in the 'Waveform' panel, and its output is send to the audio output. However the phase of this oscillator can be reset by the period of the master oscillator, forcing the slave to begin re-reading its waveform from the be
