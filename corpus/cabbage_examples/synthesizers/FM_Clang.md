...
file: examples/Instruments/Synths/FM_Clang.csd
title: "A  M  P  L  I  T  U  D  E"
type: cabbage_example
widgets: [form, image, line, label, rslider, checkbox, combobox, keyboard]
---

# A  M  P  L  I  T  U  D  E

**Category:** Synthesizers
**Source File:** `examples/Instruments/Synths/FM_Clang.csd`
**Cabbage Widgets:** form, image, line, label, rslider, checkbox, combobox, keyboard

## Description

FM_Clang.csd Written by Iain McCurdy, 2014 An FM synthesis based instrument that specialises in creating percussive metallic 'clang'-like sounds. AMPLITUDE   -    controls pertaining to the control of each notes amplitude Level       -    Global amplitude control Attack      -    Attack time. Actually just a small range of control but increasing it can soften the attack subtly Vel.Att.    -    Degree to which lower note velocities lengthen attack time. Duration    -    Duration of the overall am
