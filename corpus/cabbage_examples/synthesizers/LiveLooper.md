...
file: examples/LiveSampling/LiveLooper.csd
title: "Crossfade"
type: cabbage_example
widgets: [form, image, label, rslider, gentable, button, nslider, combobox, keyboard]
---

# Crossfade

**Category:** Synthesizers
**Source File:** `examples/LiveSampling/LiveLooper.csd`
**Cabbage Widgets:** form, image, label, rslider, gentable, button, nslider, combobox, keyboard

## Description

LiveLooper.csd Written by Iain McCurdy 2015 A simple instrument for recording a sample and then playing it back as a loop with a crossfade employed to smooth the join between the beginning and the end of the loop  (flooper2 opcode). Maximum loop time is about a minute and a half at sr = 44100 The crossfade curve shape and its duration can be modified to suit the material being looped The curve shape is based on a fragment of a sine curve If a dip in power is heard at the crossfade point, 'Shape'
