...
file: examples/GEN/GEN10.csd
title: "Str.1"
type: cabbage_example
widgets: [form, gentable, rslider, checkbox, label, keyboard]
---

# Str.1

**Category:** Synthesizers
**Source File:** `examples/GEN/GEN10.csd`
**Cabbage Widgets:** form, gentable, rslider, checkbox, label, keyboard

## Description

GEN10.csd Written by Iain McCurdy, 2013 Demonstration of GEN10 Create a wave and then play it using the keyboard Negative strength values result in inverted phase
