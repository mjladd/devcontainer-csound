...
file: examples/Instruments/Noise/WhiteNoise.csd
title: "On/Off"
type: cabbage_example
widgets: [form, image, checkbox, rslider, gentable, label]
---

# On/Off

**Category:** Synthesizers
**Source File:** `examples/Instruments/Noise/WhiteNoise.csd`
**Cabbage Widgets:** form, image, checkbox, rslider, gentable, label

## Description

WhiteNoise Iain McCurdy Demonstration of the 'noise' opcode
