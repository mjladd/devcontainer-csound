...
file: examples/Instruments/Synths/hsboscil_synth.csd
title: "Amplitude"
type: cabbage_example
widgets: [form, groupbox, rslider, line, label, combobox, keyboard]
---

# Amplitude

**Category:** Synthesizers
**Source File:** `examples/Instruments/Synths/hsboscil_synth.csd`
**Cabbage Widgets:** form, groupbox, rslider, line, label, combobox, keyboard

## Description

hsboscil_synth.csd Synthesizer is divided into seven panels. Amplitude --------- Amp    -    amplitude control Att.    -    amplitude envelope attack time Dec.    -    amplitude envelope decay time Sus.    -    amplitude envelope sustain level Rel.    -    amplitude envelope release time Mod.Shape-    shape used for amplitude modulation (tremolo). Choose from sine shaped, random splines, random sample and hold (randomh) or square wave. Rate    -    rate of amplitude LFO (tremolo)
