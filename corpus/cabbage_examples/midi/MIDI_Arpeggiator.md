...
category: MIDI
file: examples/MIDI/MIDI_Arpeggiator.csd
title: "Arpeggiator"
type: cabbage_example
widgets: [form, groupbox, rslider, label, combobox, button, checkbox, keyboard]
---

# Arpeggiator

**Category:** MIDI
**Source File:** `examples/MIDI/MIDI_Arpeggiator.csd`
**Cabbage Widgets:** form, groupbox, rslider, label, combobox, button, checkbox, keyboard

## Description

MIDI Arpeggiator.csd Written by Iain McCurdy, 2015. Based on the Arpeggiator (2012) example. Interval   - interval (in semitones) between repeats of the arpeggio Cycles     - number of repeats of the arpeggio Cycle Mode - shifting mode for the cyclical repetitions (Up or Up/Down) Arp Mode   - way in which held notes are repeated: 1. Up, from low to high 2. Down, from high to low 3. Up-Down, first from low to high, then from high to low 4. Random Dir., as in a Markov Chain or a Drunk Walk 5. Rand
