...
category: MIDI
file: examples/Miscellaneous/MIDI-CC-Out.csd
title: "Ctrl70-Chan1"
...
**Category:** MIDI
**Source File:** `examples/Miscellaneous/MIDI-CC-Out.csd`
**Cabbage Widgets:** form, rslider

## Description

Initialize the global variables. this instrument will send CC message to its MIDI putput whenever a slider changes value.
