...
category: MIDI
file: examples/Miscellaneous/IncomingMIDI.csd
title: "Midi Input"
type: cabbage_example
widgets: [form, image, label, keyboard]
---

# Midi Input

**Category:** MIDI
**Source File:** `examples/Miscellaneous/IncomingMIDI.csd`
**Cabbage Widgets:** form, image, label, keyboard
