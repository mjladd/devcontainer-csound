...
category: MIDI
file: examples/MIDI/FunctionGenerator.csd
title: "G E N E R A T O R"
type: cabbage_example
widgets: [form, image, label, combobox, rslider, button, checkbox]
---

# G E N E R A T O R

**Category:** MIDI
**Source File:** `examples/MIDI/FunctionGenerator.csd`
**Cabbage Widgets:** form, image, label, combobox, rslider, button, checkbox

## Description

FunctionGenerator.csd Written by Iain McCurdy, 2015 GENERATOR section generates a function using one of a variety of methods. (The range of values output by 'GENERATOR' are always within the range zero to 1.) TRANSFORM warps the function output by GENERATOR in one of a variety of ways. (Can also be bypassed.) RESCALE reScales the function to lie between the given limits. GENERATOR sine        -    sine wave LFO
