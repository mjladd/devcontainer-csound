...
category: MIDI
file: examples/Miscellaneous/cabbageMidiListener.csd
title: "cabbageMidiListener"
...
**Category:** MIDI
**Source File:** `examples/Miscellaneous/cabbageMidiListener.csd`
**Cabbage Widgets:** form, keyboard

## Description

Initialize the global variables. always on and recieving events from cabbageMidiListener
