...
category: General
file: examples/FilePlayers/Flooper2FilePlayer.csd
title: "Open File"
type: cabbage_example
widgets: [form, image, soundfiler, label, filebutton, checkbox, combobox, line, rslider, keyboard]
---

# Open File

**Category:** General
**Source File:** `examples/FilePlayers/Flooper2FilePlayer.csd`
**Cabbage Widgets:** form, image, soundfiler, label, filebutton, checkbox, combobox, line, rslider, keyboard

## Description

Flooper2FilePlayer.csd Written by Iain McCurdy, 2014 Load a user selected sound file into a GEN 01 function table and plays it back using flooper2. This file player is best suited for polyphonic playback and is less well suited for the playback of very long sound files . The sound file can be played back using the Play/Stop button (and the 'Transpose' / 'Speed' buttons to implement pitch/speed change) or it can be played back using the MIDI keyboard. The loop points can be set either by using th
