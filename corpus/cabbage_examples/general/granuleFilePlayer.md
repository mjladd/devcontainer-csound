...
category: General
file: examples/FilePlayers/granuleFilePlayer.csd
title: "Open File"
type: cabbage_example
widgets: [form, soundfiler, keyboard, filebutton, checkbox, rslider, label, combobox, image]
---

# Open File

**Category:** General
**Source File:** `examples/FilePlayers/granuleFilePlayer.csd`
**Cabbage Widgets:** form, soundfiler, keyboard, filebutton, checkbox, rslider, label, combobox, image

## Description

granuleFilePlayer.csd Written by Iain McCurdy, 2023 Level       - output level control N.Voices    - number of simultaneous granular synthesis voices (layers). This is limited to 128 layers but if more are needed just trigger multiple notes. Speed Ratio - speed of movement through the sound file as a ratio with normal speed Grain Mode  - directoin of the playback of each individual grain: Fwd, Bwd or randomly Fwd or Bwd Start       - where to start reading grains from within the chosen sound fil
