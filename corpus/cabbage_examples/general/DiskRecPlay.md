...
category: General
file: examples/LiveSampling/DiskRecPlay.csd
title: "Record"
type: cabbage_example
widgets: [form, groupbox, checkbox, hslider]
---

# Record

**Category:** General
**Source File:** `examples/LiveSampling/DiskRecPlay.csd`
**Cabbage Widgets:** form, groupbox, checkbox, hslider

## Description

DiskRecPlay.csd Written by Iain McCurdy, 2012
