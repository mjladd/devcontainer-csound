...
category: General
file: examples/FilePlayers/TemposcalFilePlayer.csd
title: "Open"
type: cabbage_example
widgets: [form, image, soundfiler, label, filebutton, checkbox, combobox, rslider, keyboard]
---

# Open

**Category:** General
**Source File:** `examples/FilePlayers/TemposcalFilePlayer.csd`
**Cabbage Widgets:** form, image, soundfiler, label, filebutton, checkbox, combobox, rslider, keyboard

## Description

TemposcalFilePlayer.csd Written by Iain McCurdy, 2014. Load a user selected sound file into a GEN 01 function table and plays it back using temposcal. The sound file can be played back using the Play/Stop button (and the 'Transpose' and 'Speed' buttons to implement pitch abd speed changes independently. Playing back using the MIDI keyboard will implement pitch changes based on key played. The MIDI sustain pedal will also activate the freeze function
