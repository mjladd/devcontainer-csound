...
category: General
file: examples/FilePlayers/FileStretcher.csd
title: "Click and drag on waveform to select sound portion for time stretching..."
type: cabbage_example
widgets: [form, image, soundfiler, label, filebutton, button, combobox, rslider, checkbox, keyboard]
---

# Click and drag on waveform to select sound portion for time stretching...

**Category:** General
**Source File:** `examples/FilePlayers/FileStretcher.csd`
**Cabbage Widgets:** form, image, soundfiler, label, filebutton, button, combobox, rslider, checkbox, keyboard

## Description

FileStretcher.csd Written by Iain McCurdy, 2014/2021 Used to create a time-stretched version of an input file Often when time-stretching a sound when wishing to retain the priniciple characteristics of the source sound, we play the attack portion of the sound at normal speed (as well, often, as the release portion) and only stretch sound in the middle of the source - often called the 'sustain' portion. This example facilitates this technique by allowing the user to select the portion of sound to
