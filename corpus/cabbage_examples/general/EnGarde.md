...
category: General
file: examples/ProceduralAudio/EnGarde.csd
title: "Draw Sword"
type: cabbage_example
widgets: [form, button, groupbox, rslider, image, hslider]
---

# Draw Sword

**Category:** General
**Source File:** `examples/ProceduralAudio/EnGarde.csd`
**Cabbage Widgets:** form, button, groupbox, rslider, image, hslider

## Description

En Garde! (Drawing a sword: precedural audio) Iain McCurdy, 2017 Drawing Sword (groupbox) ------------------------ Density		-	roughness of the texture of the sword Draw duration	-	time taken to draw the sword from the scabbard Freq.1 [start]/Freq.1 [end] Freq.2 [start]/Freq.2 [end] -	start and end frequencies for the plate modelling for the drawing of the sword sound Feedback		-	basically the inverse of the damping of the sword while it is begin drawn Draw Gain		-	amplitude gain of the sword bei
