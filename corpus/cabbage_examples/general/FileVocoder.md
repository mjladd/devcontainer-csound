...
category: General
file: examples/FilePlayers/FileVocoder.csd
title: "OPEN FILE 1"
type: cabbage_example
widgets: [form, image, soundfiler, label, filebutton, rslider, button, combobox]
---

# OPEN FILE 1

**Category:** General
**Source File:** `examples/FilePlayers/FileVocoder.csd`
**Cabbage Widgets:** form, image, soundfiler, label, filebutton, rslider, button, combobox

## Description

File Vocoder Iain McCurdy 2021 Performs cross-synthesis (vocoding) using frequency domain processing (pvscross opcode) First load two contrasting sound files into the provided slots. Click 'CROSS SYNTHESISE' to perform the cross-synthesis (vocoding) Playback speeds and pitches (frequency scaling) for each contributing sound file can be adjusted using dials. Check what each sound file sounds like by clicking on 'Audition' in the relevant slot. Change the number of frequency channels (frequency re
