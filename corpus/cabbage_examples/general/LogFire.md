...
category: General
file: examples/ProceduralAudio/LogFire.csd
title: "Start Fire"
...
**Category:** General
**Source File:** `examples/ProceduralAudio/LogFire.csd`
**Cabbage Widgets:** form, image, button, rslider

## Description

Log Fire Based on work by Eric Grehan, Rory Walsh and Iain McCurdy, 2017 Initialize the global variables. sr is set by the host
