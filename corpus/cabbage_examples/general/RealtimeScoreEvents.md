...
category: General
file: examples/Instructional/RealtimeScoreEvents.csd
title: "Enter a score event for instrument 2 or 3..."
type: cabbage_example
widgets: [form, label, texteditor, button, csoundoutput, textBox]
---

# Enter a score event for instrument 2 or 3...

**Category:** General
**Source File:** `examples/Instructional/RealtimeScoreEvents.csd`
**Cabbage Widgets:** form, label, texteditor, button, csoundoutput, textBox

## Description

RealtimeScoreEvents.csd Sending traditional Csound score events typed in using Cabbage's textedit widget Written by Iain McCurdy, 2015. Borrowing from Rory Walsh's 'TextEditor.csd' example.
