...
category: General
file: examples/FilePlayers/DiskinFilePlayer.csd
title: "Open File"
type: cabbage_example
widgets: [form, image, soundfiler, label, filebutton, checkbox, combobox, rslider, nslider, keyboard]
---

# Open File

**Category:** General
**Source File:** `examples/FilePlayers/DiskinFilePlayer.csd`
**Cabbage Widgets:** form, image, soundfiler, label, filebutton, checkbox, combobox, rslider, nslider, keyboard

## Description

DiskinFilePlayer.csd Written by Iain McCurdy Plays a user selected sound file using diskin2 opcode. This file player is best suited for the playback of very long sound files and is less well suited for polyphonic playback. The sound file can be played back using the Play/Stop button (and the 'Transpose' / 'Speed' buttons to implement pitch/speed change) or it can be played back using the MIDI keyboard. Note that for 'reverse' to be effective either 'loop' needs to be active or inskip needs to be
