...
category: General
file: examples/FilePlayers/SyncgrainFilePlayer.csd
title: "Open File"
type: cabbage_example
widgets: [form, image, soundfiler, keyboard, filebutton, checkbox, label, rslider, combobox, line]
---

# Open File

**Category:** General
**Source File:** `examples/FilePlayers/SyncgrainFilePlayer.csd`
**Cabbage Widgets:** form, image, soundfiler, keyboard, filebutton, checkbox, label, rslider, combobox, line

## Description

SyncgrainFilePlayer.csd Written by Iain McCurdy, 2014 The internal pointer used by syncgrain to track progress through the sound file is affected by grain size and density as well as speed so on accaount of this complication a scrubber line in the waveform view is not yet implemented.
