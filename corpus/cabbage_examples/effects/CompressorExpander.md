...
category: Effects
file: examples/Effects/Dynamics/CompressorExpander.csd
title: "Threshold"
type: cabbage_example
widgets: [form, image, rslider, gentable]
---

# Threshold

**Category:** Effects
**Source File:** `examples/Effects/Dynamics/CompressorExpander.csd`
**Cabbage Widgets:** form, image, rslider, gentable

## Description

Compressor/Expander.csd Written by Iain McCurdy, 2015. A dynamics processor Read point on the transfer function is indicated by a moving dot. Threshold -   threshold point at which the main dynamics processing curve begins Compress  -   degree of dynamic compression of the dynamic area beneath the threshold Curve     -   curve of the main dynamics processing segment Ceiling   -   dynamic ceiling. Shifts main dynamic curve to the left in the transfer function. Attack    -   Attack time of the dyn
