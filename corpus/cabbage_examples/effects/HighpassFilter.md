...
category: Effects
file: examples/Effects/Filters/HighpassFilter.csd
title: "INPUT"
...
**Category:** Effects
**Source File:** `examples/Effects/Filters/HighpassFilter.csd`
**Cabbage Widgets:** form, image, label, combobox, rslider

## Description

HighpassFilter.csd Written by Iain McCurdy, 2012, 2021
