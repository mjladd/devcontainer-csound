...
category: Effects
file: examples/Effects/Time/Reverse.csd
title: "Time L"
...
**Category:** Effects
**Source File:** `examples/Effects/Time/Reverse.csd`
**Cabbage Widgets:** form, image, rslider, checkbox

## Description

Reverse.csd Iain McCurdy [2012] Buffers audio for reversed (and forward) playback. INSTRUCTIONS ------------ Time L      --    length of the left channel delay buffer Time R      --    length of the right channel delay buffer Spread        --    stereo spread of the two channel. 1 = hard left and right Mix        --    dry/wet mix Level        --    output level Reverse     --    (switch) activate reversed buffer
