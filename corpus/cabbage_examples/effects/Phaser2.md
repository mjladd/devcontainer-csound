...
category: Effects
file: examples/Effects/Filters/Phaser2.csd
title: "INPUT"
type: cabbage_example
widgets: [form, image, label, checkbox, rslider, combobox]
---

# INPUT

**Category:** Effects
**Source File:** `examples/Effects/Filters/Phaser2.csd`
**Cabbage Widgets:** form, image, label, checkbox, rslider, combobox

## Description

phaser.csd Written by Iain McCurdy, 2012.
