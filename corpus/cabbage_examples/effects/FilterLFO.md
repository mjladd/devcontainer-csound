...
category: Effects
file: examples/Effects/Filters/FilterLFO.csd
title: "Freq."
type: cabbage_example
widgets: [form, image, rslider, label, combobox, button, groupbox, line, checkbox]
---

# Freq.

**Category:** Effects
**Source File:** `examples/Effects/Filters/FilterLFO.csd`
**Cabbage Widgets:** form, image, rslider, label, combobox, button, groupbox, line, checkbox

## Description

FilterLFO.csd Author: Iain McCurdy (2013) INTRODUCTION ------------ multimode filter with a 2 multimode LFOs on the cutoff frequency additional controls for specific filter models are accessed using the pop-up buttons The outputs of both LFOs are added to the main cutoff frequency (Freq.) LFO amplitude are in 'octaves' LFO rates are in beats per minute 'Smoothing' adds a small amount of portamento to changes in cutoff frequency this can be useful in square wave-type modulations
