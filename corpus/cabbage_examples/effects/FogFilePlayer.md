...
category: Effects
file: examples/FilePlayers/FogFilePlayer.csd
title: "Manual"
type: cabbage_example
widgets: [form, image, soundfiler, label, hslider, filebutton, checkbox, combobox, rslider, button]
---

# Manual

**Category:** Effects
**Source File:** `examples/FilePlayers/FogFilePlayer.csd`
**Cabbage Widgets:** form, image, soundfiler, label, hslider, filebutton, checkbox, combobox, rslider, button

## Description

FogFilePlayer.csd Written by Iain McCurdy, 2015 File player based around the granular synthesis opcode, 'fog'. A second voice can be activated (basically another parallel granular synthesiser) with parameter ariations of density, transposition, pointer location (Phs) and delay. Two modes of playback are available: manual pointer and speed The pointer and grain density can also be modulated by clicking and dragging on the waeform iew. * This will also start and stop the grain producing instrument
