...
category: Effects
file: examples/Effects/Time/NoWarpDelay.csd
title: "In Gain"
type: cabbage_example
widgets: [form, rslider, checkbox, label, combobox]
---

# In Gain

**Category:** Effects
**Source File:** `examples/Effects/Time/NoWarpDelay.csd`
**Cabbage Widgets:** form, rslider, checkbox, label, combobox

## Description

No-Warp Delay Iain McCurdy, 2021 This is a dual/stereo delay effect using streaming phase vocoding so that changes in the delay tome will not cause glitches or pitch warping effects. The number of echoes is controlled by defination of the RT60 value so that rate of decay is independent of delay time (unlike when using a feedback ratio control) Maximum delay time is 5 seconds In Gain         - gain control on the input signal Time L / Time R - control the delay times on the left and right channel
