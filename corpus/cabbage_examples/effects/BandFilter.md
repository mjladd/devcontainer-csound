...
category: Effects
file: examples/Effects/Filters/BandFilter.csd
title: "x:cutoff | y:bandwidth"
type: cabbage_example
widgets: [form, xypad, checkbox, label, combobox, rslider, nslider]
---

# x:cutoff | y:bandwidth

**Category:** Effects
**Source File:** `examples/Effects/Filters/BandFilter.csd`
**Cabbage Widgets:** form, xypad, checkbox, label, combobox, rslider, nslider

## Description

BandFilter.csd Written by Iain McCurdy, 2012.
