...
category: Effects
file: examples/Effects/Dynamics/Gate.csd
title: "Processing Configuration:"
type: cabbage_example
widgets: [form, image, label, combobox, rslider, nslider, checkbox, hrange]
---

# Processing Configuration:

**Category:** Effects
**Source File:** `examples/Effects/Dynamics/Gate.csd`
**Cabbage Widgets:** form, image, label, combobox, rslider, nslider, checkbox, hrange

## Description

Gate.csd Written by Iain McCurdy, 2015. Two 'Processing Configutions' are available: 'Stereo Mixed'       -   the two input channels are mixed before being sent to a single envelope follower. Subsequent processing (gating filtering) is still carried out on the stereo input, just the gate open/closed control data will be the same on both channels 'Stereo Separate'        -   the two input channels are sent to independent envelope followers. Therefore gate open/closed control data for the two chan
