...
category: Effects
file: examples/Effects/Filters/HarpFilter.csd
title: "Keyboard"
type: cabbage_example
widgets: [form, image, label, combobox, rslider, nslider, checkbox, keyboard]
---

# Keyboard

**Category:** Effects
**Source File:** `examples/Effects/Filters/HarpFilter.csd`
**Cabbage Widgets:** form, image, label, combobox, rslider, nslider, checkbox, keyboard

## Description

HarpFilter.csd Creates a stack of waveguides simulating a resonating bank of strings ** WARNING **   THIS EFFECT CAN APPLY VAST AMOUNTS OF RESONATING FEEDBACK THEREFORE LARGE AMOUNTS OF GAIN ARE POSSIBLE. TAKE PARTICULAR CARE WHEN USING A LIVE AUDIO INPUT. IF IN DOUBT, REDUCE THE FEEDBACK VALUE. Tunings of strings are not controlled individually but are instead defined using several global controls. Frequency       -    Base frequency of the stack of waveguide filters Cutoff          -    Cutoff
