...
category: Effects
file: examples/Effects/Modulation/PhaserLFO.csd
title: "INPUT"
type: cabbage_example
widgets: [form, image, label, combobox, line, rslider]
---

# INPUT

**Category:** Effects
**Source File:** `examples/Effects/Modulation/PhaserLFO.csd`
**Cabbage Widgets:** form, image, label, combobox, line, rslider

## Description

PhaserLFO.csd Written by Iain McCurdy, 2012.
