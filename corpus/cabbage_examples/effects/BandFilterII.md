...
category: Effects
file: examples/Effects/Filters/BandFilterII.csd
title: "Test Sound"
type: cabbage_example
widgets: [form, checkbox, xypad, hrange, label, combobox, rslider, hslider]
---

# Test Sound

**Category:** Effects
**Source File:** `examples/Effects/Filters/BandFilterII.csd`
**Cabbage Widgets:** form, checkbox, xypad, hrange, label, combobox, rslider, hslider

## Description

BandFilterII.csd Written by Iain McCurdy, 2015. Modify filter limits using the xypad The limit double slider is more just for display.
