...
category: Effects
file: examples/Effects/Spectral/Shredulator.csd
title: "SHREDULATOR"
type: cabbage_example
widgets: [form, image, label, combobox, rslider]
---

# SHREDULATOR

**Category:** Effects
**Source File:** `examples/Effects/Spectral/Shredulator.csd`
**Cabbage Widgets:** form, image, label, combobox, rslider

## Description

Shredulator.csd Written by Iain McCurdy, 2016 This effect implements an FFT delay, the delay time of which can be shifted using a random sample and gold function. In sync with this random function, amplitude can also be randomised ('Granulate' control), as can transposition. CONTROLS -------- FFT Size        -  size of FFT window: smaller sizes provides better time resolution but possible distortion of frequency components Max Delay       -  Maximum delay time as defined by the circular (pvs) bu
