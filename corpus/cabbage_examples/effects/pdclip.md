...
category: Effects
file: examples/Effects/Distortion/pdclip.csd
title: "pdclip"
type: cabbage_example
widgets: [form, label, image, rslider, combobox, checkbox, gentable]
---

# pdclip

**Category:** Effects
**Source File:** `examples/Effects/Distortion/pdclip.csd`
**Cabbage Widgets:** form, label, image, rslider, combobox, checkbox, gentable

## Description

pdclip.csd Written by Iain McCurdy, 2012.
