...
category: Effects
file: examples/Effects/Distortion/clip.csd
title: "Input Gain"
type: cabbage_example
widgets: [form, image, rslider, checkbox, label, combobox, gentable]
---

# Input Gain

**Category:** Effects
**Source File:** `examples/Effects/Distortion/clip.csd`
**Cabbage Widgets:** form, image, rslider, checkbox, label, combobox, gentable
