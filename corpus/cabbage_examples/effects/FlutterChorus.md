...
category: Effects
file: examples/Effects/Modulation/FlutterChorus.csd
title: "Input Gain"
type: cabbage_example
widgets: [form, rslider, image, label, combobox]
---

# Input Gain

**Category:** Effects
**Source File:** `examples/Effects/Modulation/FlutterChorus.csd`
**Cabbage Widgets:** form, rslider, image, label, combobox

## Description

Flutter Chorus Iain McCurdy. 2021. Modulates delay time (pitch warping) and amplitude iteratively as delays regenerate This means that the longer a sound echoes within the delay, the more pitch and/or amplitude modulated it becomes. Input Gain      - gain control on the audio signal entering the delay Delay Time      - delay time in seconds Feedback        - ratio of signal leaving the delay that is fed back into the input Damping         - cutoff frequency of a 6db/oct lowpass filter within the
