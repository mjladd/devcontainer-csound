...
category: Effects
file: examples/Effects/Time/ModulatingDelays.csd
title: "G A T E"
type: cabbage_example
widgets: [form, label, checkbox, rslider, line, hrange]
---

# G A T E

**Category:** Effects
**Source File:** `examples/Effects/Time/ModulatingDelays.csd`
**Cabbage Widgets:** form, label, checkbox, rslider, line, hrange

## Description

Modulating Delays -  randomly modulating delays GATE (for gating the incoming signal) On Thrsh / Off Thrsh    -    thresholds at which the gate will open and close Rise Time        -    time it takes for the gate to ramp open Rel Time        -    time it takes for the gate to ramp closed SETUP Pan Width        -    extent of the random panning effect (0 = all layers centred) Spread        -    spread of the delay times of the different layers (if only 1 layer is active this control isn't really
