...
category: Effects
file: examples/Effects/Distortion/LoFi.csd
title: "Test Tone"
type: cabbage_example
widgets: [form, checkbox, rslider]
---

# Test Tone

**Category:** Effects
**Source File:** `examples/Effects/Distortion/LoFi.csd`
**Cabbage Widgets:** form, checkbox, rslider

## Description

LoFi.csd Written by Iain McCurdy, 2012.
