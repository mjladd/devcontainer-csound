...
category: Effects
file: examples/Effects/Time/SpringReverb.csd
title: "I N P U T"
type: cabbage_example
widgets: [form, groupbox, label, combobox, rslider, checkbox, gentable, image]
---

# I N P U T

**Category:** Effects
**Source File:** `examples/Effects/Time/SpringReverb.csd`
**Cabbage Widgets:** form, groupbox, label, combobox, rslider, checkbox, gentable, image

## Description

Spring Reverb Iain McCurdy, 2021 I N P U T INPUT - how the stereo input is matrixed into the effect: 1. Left channel only (send to both outputs) 2. Sum L&R (left and right channels are mixed then sent into a mono spring reverb, same signal sent to both outputs) 3. Dual Stereo (dual spring reverbs process left and right channels independently) D E L A Y S The three main echos/springs (in parallel) that comprise the reverb. Times can be adjusted independently and each spring can be activated or de
