...
category: Effects
file: examples/FunAndGames/River.csd
title: "G  U  L  P"
type: cabbage_example
widgets: [form, gentable, image, label, checkbox, rslider]
---

# G  U  L  P

**Category:** Effects
**Source File:** `examples/FunAndGames/River.csd`
**Cabbage Widgets:** form, gentable, image, label, checkbox, rslider

## Description

River Synth Iain McCurdy, 2021 Procedural audio synthesis of a river using granular synthesis and noise The sound of a river is separated into three layers: 1. Gulp (sparse low pitch glissando grains) 2. Roar (dense filtered noise) 3. Burble (medium density) GULP Level    - amplitude level Density  - average density of gulps Duration - average duration of gulps
