...
category: Effects
file: examples/Effects/Time/TempoDelay.csd
title: "Tempo"
type: cabbage_example
widgets: [form, image, rslider, label, button]
---

# Tempo

**Category:** Effects
**Source File:** `examples/Effects/Time/TempoDelay.csd`
**Cabbage Widgets:** form, image, rslider, label, button

## Description

TempoDelay.csd Written by Iain McCurdy, 2012. Units for the delay are assumed to be demi-semiquavers. Knob for Rhy.Mult. will be replaced with a combobox once comboboxes work in plugins within hosts. Width control only applicable when ping-pong delay selected. If 'external' is selected as clock source tempo is taken from the host's BPM.
