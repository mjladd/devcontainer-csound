...
**Category:** Effects
**Source File:** `examples/GEN/GEN17.csd`
**Cabbage Widgets:** form, gentable, image, groupbox, rslider, checkbox

## Description

Demonstration of GEN17 Written by Iain McCurdy, 2014. GEN17 is used to create histograms (step functions) in which the use defines locations and values. That value is then held until the next location is specified. In this example the histogram is used as a probability distribution from which notes are randomly chosen. Values define (midi) note numbers.
