...
category: Effects
file: examples/Effects/Modulation/StereoChorus.csd
title: "LFO Type:"
...
**Category:** Effects
**Source File:** `examples/Effects/Modulation/StereoChorus.csd`
**Cabbage Widgets:** form, image, label, combobox, rslider

## Description

StereoChorus.csd Written by Iain McCurdy, 2012. Two LFO modes are offered, sines and rsplines. Dereg. (deregulate) adds a random modulation to both LFO rate and depth in both LFO modes
