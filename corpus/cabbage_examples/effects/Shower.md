...
category: Effects
file: examples/FunAndGames/Shower.csd
title: "TAP"
...
**Category:** Effects
**Source File:** `examples/FunAndGames/Shower.csd`
**Cabbage Widgets:** form, image, rslider

## Description

Shower Iain McCurdy, 2021 Physical model of a shower including a squeaking tap TAP      - adjusts the intensity of the stream of water (density of drips) Duration - duration of the individual drips Pitch    - even though the pitches of the drips are slightly random, this controls the average pitch Spread   - random range of the pitches of drips
