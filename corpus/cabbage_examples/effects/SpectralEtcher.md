...
category: Effects
file: examples/Effects/Spectral/SpectralEtcher.csd
title: "Fundamental"
type: cabbage_example
widgets: [form, image, soundfiler, signaldisplay, label, button, nslider, filebutton, combobox, rslider]
---

# Fundamental

**Category:** Effects
**Source File:** `examples/Effects/Spectral/SpectralEtcher.csd`
**Cabbage Widgets:** form, image, soundfiler, signaldisplay, label, button, nslider, filebutton, combobox, rslider

## Description

Spectral Etcher Iain McCurdy 2021 Applies a range of spectral procedures to a chosen sound file OPEN FILE - browse for a sound file FILE      - play your sound file (once loaded) in a loop LIVE      - process live input. This mode is also recommended if you are using Spectral Etching as a plugin in a DAW REC OUT - render your work to a sound file (file will be placed in the same directory as the source sound file) FFT Size - Equates to frequency resolution (number of freq divisions) and inversel
