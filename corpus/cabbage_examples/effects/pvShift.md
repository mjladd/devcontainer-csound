...
category: Effects
file: examples/Effects/Spectral/pvShift.csd
title: "Coarse"
...
**Category:** Effects
**Source File:** `examples/Effects/Spectral/pvShift.csd`
**Cabbage Widgets:** form, image, rslider, label, combobox

## Description

pvShift.csd Written by Iain McCurdy, 2012. Streaming phase vocoding frequency shifter.
