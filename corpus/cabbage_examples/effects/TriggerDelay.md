...
category: Effects
file: examples/Effects/Time/TriggerDelay.csd
title: "Threshold"
type: cabbage_example
widgets: [form, image, rslider, label, checkbox, nslider, line, xypad]
---

# Threshold

**Category:** Effects
**Source File:** `examples/Effects/Time/TriggerDelay.csd`
**Cabbage Widgets:** form, image, rslider, label, checkbox, nslider, line, xypad

## Description

TriggerDelay.csd Written by Iain McCurdy, 2012. This example works best with sharp percussive sounds A trigger impulse is generated each time the rms of the input signal crosses the defined 'Threshold' value. Each time a new trigger is generated a new random delay time (between user definable limits) - and a new random feedback value (again between user definable limits) are generated. It is possible to generate feedback values of 1 and greater (which can lead to a continuous build-up of sound)
