...
category: Effects
file: examples/FunAndGames/Bubbles.csd
title: "Burst the Bubbles..."
type: cabbage_example
widgets: [form, label, image]
---

# Burst the Bubbles...

**Category:** Effects
**Source File:** `examples/FunAndGames/Bubbles.csd`
**Cabbage Widgets:** form, label, image

## Description

Bubbles.csd Written by Iain McCurdy, 2014 A simple game that is intended to demonstrate moving Cabbage widgets in this case 'image' and interacting with those moving widgets using the mouse. The user bursts rising bubbles by clicking on them (a 'burst' is rewraded with a pizzicato-type sound). The higher up the panel a bubble is burst, the higher the note it produces. Horizontal position across the panel corresponds to panning location of the sound produced. The size of the bubble corresponds to
