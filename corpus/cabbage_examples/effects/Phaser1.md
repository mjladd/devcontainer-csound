...
category: Effects
file: examples/Effects/Filters/Phaser1.csd
title: "INPUT"
type: cabbage_example
widgets: [form, image, label, checkbox, rslider, combobox, keyboard]
---

# INPUT

**Category:** Effects
**Source File:** `examples/Effects/Filters/Phaser1.csd`
**Cabbage Widgets:** form, image, label, checkbox, rslider, combobox, keyboard

## Description

phaser1.csd Written by Iain McCurdy, 2012.
