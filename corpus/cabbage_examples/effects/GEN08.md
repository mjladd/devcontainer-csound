...
category: Effects
file: examples/GEN/GEN08.csd
title: "Nodes"
type: cabbage_example
widgets: [form, gentable, rslider, keyboard]
---

# Nodes

**Category:** Effects
**Source File:** `examples/GEN/GEN08.csd`
**Cabbage Widgets:** form, gentable, rslider, keyboard

## Description

GEN08.csd Written by Iain McCurdy, 2013 Demonstration of GEN08 (generates as smooth a line as possible between a sequence of user-defined break points) The user defines a number of nodes (the amplitude values at these nodes are modulated randomly) Random value sequence can be wrapped so that values are repeated for higher nodes. Nodes        -    number of nodes Wrap        -    number of nodes before wrap-around Speed        -    speed of random modulation Level        -    amplitude level of t
