...
category: Effects
file: examples/Effects/Filters/CombFilters.csd
title: "LIVE"
type: cabbage_example
widgets: [form, image, button, hslider]
---

# LIVE

**Category:** Effects
**Source File:** `examples/Effects/Filters/CombFilters.csd`
**Cabbage Widgets:** form, image, button, hslider

## Description

CombFilters.csd Written by Iain McCurdy 2023 A set of six parallel comb filters
