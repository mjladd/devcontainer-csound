...
category: Effects
file: examples/Effects/Modulation/Doppler.csd
title: "Input:"
type: cabbage_example
widgets: [form, label, combobox, rslider, hslider]
---

# Input:

**Category:** Effects
**Source File:** `examples/Effects/Modulation/Doppler.csd`
**Cabbage Widgets:** form, label, combobox, rslider, hslider

## Description

doppler.csd Written by Iain McCurdy, 2013 CONTROLS Input          -    select input: either left channel, right channel, or a mix of both channels Shape          -    shape of the LFO moving the source: either sine, triangle, random spline OR manual note, if 'random' is chosen, 'speed' can take a little while to respond to changes made to the 'speed' control is the speed was previously slow If 'manual' is selected source position is controlled using the on screen slider Room Size       -   effec
