...
category: Effects
file: examples/Effects/Distortion/Powershape.csd
title: "Sine Test"
type: cabbage_example
widgets: [form, image, checkbox, hslider, label, nslider, rslider, gentable]
---

# Sine Test

**Category:** Effects
**Source File:** `examples/Effects/Distortion/Powershape.csd`
**Cabbage Widgets:** form, image, checkbox, hslider, label, nslider, rslider, gentable

## Description

Powershape.csd Iain McCurdy 2012 Encapsulation of the powershape opcode used for wave distortion CONTROLS -------- Test Tone --  a glissandoing test tone Amount    --  amount of distortion Level     --  output level
