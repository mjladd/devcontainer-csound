...
category: Effects
file: examples/Effects/Modulation/DopplerSpin.csd
title: "i  n  p  u  t"
type: cabbage_example
widgets: [form, label, combobox, line, checkbox, rslider, hslider]
---

# i  n  p  u  t

**Category:** Effects
**Source File:** `examples/Effects/Modulation/DopplerSpin.csd`
**Cabbage Widgets:** form, label, combobox, line, checkbox, rslider, hslider

## Description

DopplerSpin.csd Written by Iain McCurdy, 2013 CONTROLS Speed              --    Frequency of the spinning Loc.               --    Listening position in relation to the circular motion (range from ('centre' to 'edge'). Can be thought of as a control for the amount of amplitude modulation. Orient.            --    direction of listening (in radians) Width              --    width of panning directionality in the modulation Depth              --    depth of doppler effect (circle size). (Reverb) S
