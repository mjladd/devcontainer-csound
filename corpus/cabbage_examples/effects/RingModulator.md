...
category: Effects
file: examples/Effects/Spectral/RingModulator.csd
title: "Input"
type: cabbage_example
widgets: [form, image, label, combobox, rslider, vslider, line, keyboard]
---

# Input

**Category:** Effects
**Source File:** `examples/Effects/Spectral/RingModulator.csd`
**Cabbage Widgets:** form, image, label, combobox, rslider, vslider, line, keyboard

## Description

RingModulator.csd Written by Iain McCurdy, 2012. Ring Modulator -------------- Modulating waveform is a harmonic waveform based on a sawtooth waveform. The number of harmonics included is defined using 'Harms'. An offset of harmonics to omit is defined using 'Offset'. Therefore Harms=1 and Offset=0 will produce a sine wave. Input        -    input mode Freq.        -    frequency of the ring modulator (if input mode is 'Knob')
