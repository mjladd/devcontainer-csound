...
category: Effects
file: examples/Effects/Filters/clfilt.csd
title: "Freq."
...
**Category:** Effects
**Source File:** `examples/Effects/Filters/clfilt.csd`
**Cabbage Widgets:** form, image, rslider, label, combobox, checkbox

## Description

clfilt.csd Written by Iain McCurdy, 2012. Port.     -   portamento applied to changes that are made to 'Freq.'
