...
category: Effects
file: examples/Effects/Time/SpectralDelay.csd
title: "SPECTRAL DELAY"
type: cabbage_example
widgets: [form, image, label, rslider, combobox, gentable]
---

# SPECTRAL DELAY

**Category:** Effects
**Source File:** `examples/Effects/Time/SpectralDelay.csd`
**Cabbage Widgets:** form, image, label, rslider, combobox, gentable

## Description

SpectralDelay.csd Written by Iain McCurdy, 2016 This effect implements a spectral delay wherein banded analysed data - amplitudes and frequencies - can be delayed on a band by band basis and independently for each data type. Delay times are typically controlled using function tables as individual controls for each delay time would be impractical. In this example the user can choosed from 9 preset table types for delaying amplitude and frequency data. In the future I will add further tables and a
