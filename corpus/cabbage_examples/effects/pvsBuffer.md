...
category: Effects
file: examples/Effects/Spectral/pvsBuffer.csd
title: "RECORD"
type: cabbage_example
widgets: [form, image, label, rslider, combobox, button]
---

# RECORD

**Category:** Effects
**Source File:** `examples/Effects/Spectral/pvsBuffer.csd`
**Cabbage Widgets:** form, image, label, rslider, combobox, button

## Description

pvsBuffer.csd Writes audio into a circular FFT buffer. Read speed can be modified as can the frequencies. Take Care! Feedback values above 1 are intended to be used only when transposition is not unison.
