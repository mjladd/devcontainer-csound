...
category: Effects
file: examples/GEN/GEN41.csd
title: "Histogram"
type: cabbage_example
widgets: [form, gentable, image, groupbox, rslider, checkbox]
---

# Histogram

**Category:** Effects
**Source File:** `examples/GEN/GEN41.csd`
**Cabbage Widgets:** form, gentable, image, groupbox, rslider, checkbox

## Description

GEN41.csd Written by Iain McCurdy, 2014. Demonstration of GEN41 GEN41 can be used to genrate histogram-like function tables in which the number of times each value is repeated is defined by its associated probability value. The actual probabilities as fractions of 1 are the value divided by the sum of all probability values. (a total of '1' indicates all possibilities are represented.) In this example the histogram is used as a probability distribution from which notes are randomly chosen. Value
