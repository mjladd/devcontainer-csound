...
category: Effects
file: examples/Effects/Filters/wguide1.csd
title: "Keyboard Input"
type: cabbage_example
widgets: [form, image, checkbox, label, combobox, rslider, line, keyboard]
---

# Keyboard Input

**Category:** Effects
**Source File:** `examples/Effects/Filters/wguide1.csd`
**Cabbage Widgets:** form, image, checkbox, label, combobox, rslider, line, keyboard

## Description

wguide1.csd Written by Iain McCurdy, 2013,2015,2021. Encapsulation of the 'wguide1' opcode, used for filtering and synthesis. A waveguide filter produces resonance peaks that follow the frequencies of the harmonic series with diminishing strength above its defined base frequency. frequency of the wave guide can be determined either in hertz of as a note number Activating the 'Keyboard Input' switch will allow frequency control from the keyboard (internal or external) and polyphony. In this mode,
