...
category: Effects
file: examples/Effects/Spectral/pvSmooth.csd
title: "smooth"
type: cabbage_example
widgets: [form, image, label, rslider, checkbox, combobox]
---

# smooth

**Category:** Effects
**Source File:** `examples/Effects/Spectral/pvSmooth.csd`
**Cabbage Widgets:** form, image, label, rslider, checkbox, combobox

## Description

pvSmooth.csd Written by Iain McCurdy, 2012. FFT feedback is disabled if amplitude smoothing is increased beyond zero. If this is not done the instrument will fail. link    -    links 'Amp.Smooth' and 'Frq.Smooth'
