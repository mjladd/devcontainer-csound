...
category: Effects
file: examples/FilePlayers/Grain3FilePlayer.csd
title: "Manual"
...
**Category:** Effects
**Source File:** `examples/FilePlayers/Grain3FilePlayer.csd`
**Cabbage Widgets:** form, image, soundfiler, label, hslider, filebutton, checkbox, combobox, rslider, button

## Description

Grain3FilePlayer.csd Written by Iain McCurdy, 2015 File player based around the granular synthesis opcode, 'grain3'. A second voice can be activated (basically another parallel granular synthesiser) with parameter variations of density, transposition, pointer location (Phs) and delay. Two modes of playback are available: manual pointer and speed The pointer and grain density can also be modulated by right-clicking and dragging on the waveform view. * This will also start and stop the grain produ
