...
category: Effects
file: examples/FunAndGames/PingClang.csd
title: "Damping"
type: cabbage_example
widgets: [form, image, nslider, button, label]
---

# Damping

**Category:** Effects
**Source File:** `examples/FunAndGames/PingClang.csd`
**Cabbage Widgets:** form, image, nslider, button, label

## Description

PingClang.csd Written by Iain McCurdy, 2014 A musical toy. Blocks can be moved using left click and drag, and can be resized using right click and drag. The nature of the sound produced by the blocks is altered by their shape. Thin blocks will produce a more harmonic and sustaining sound. Thick blocks will produce inharmonic and less sustained sounds. Once balls come to rest on the floor they are rethrown from the top. New balls can also be launched using the 'New Ball' button.
