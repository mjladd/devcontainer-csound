...
category: Effects
file: examples/Effects/Time/StuckBuffer.csd
title: "PROBABILITY"
type: cabbage_example
widgets: [form, image, line, label, rslider, checkbox, button, combobox]
---

# PROBABILITY

**Category:** Effects
**Source File:** `examples/Effects/Time/StuckBuffer.csd`
**Cabbage Widgets:** form, image, line, label, rslider, checkbox, button, combobox

## Description

StuckBuffer.csd Written by Iain McCurdy 2014, 2022 Imitates the sound of a audio stuck buffer. CONTROLS Thresh.      -    probability of there being a stuck buffer Freq.Min     -    Rate of probability test (minimum) Freq.Max     -    Rate of probability test (maximum) Threshold setting will also affect the frequency with which new buffer sizes are generated. i.e. a threshold setting of '1' will mean that a stuck buffer will be held indefinitely. Hold (button)-    Hold the current buffer indefin
