...
category: Effects
file: examples/Effects/Filters/EnvelopeFollower.csd
title: "Sensitivity"
type: cabbage_example
widgets: [form, image, vmeter, rslider, label, combobox]
---

# Sensitivity

**Category:** Effects
**Source File:** `examples/Effects/Filters/EnvelopeFollower.csd`
**Cabbage Widgets:** form, image, vmeter, rslider, label, combobox

## Description

EnvelopeFollower.csd Written by Iain McCurdy, 2012.
