...
category: Effects
file: examples/Effects/Filters/FilterShaper.csd
title: "R A T E"
type: cabbage_example
widgets: [form, image, line, label, rslider, checkbox, combobox]
---

# R A T E

**Category:** Effects
**Source File:** `examples/Effects/Filters/FilterShaper.csd`
**Cabbage Widgets:** form, image, line, label, rslider, checkbox, combobox

## Description

FilterShaper.csd Iain McCurdy, 2015 Gestural shaping using rspline random function generators applied to lowpass filter, highpass filter, panning and amplitude
