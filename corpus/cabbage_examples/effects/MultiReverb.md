...
category: Effects
file: examples/Effects/Reverbs/MultiReverb.csd
title: "screverb"
type: cabbage_example
widgets: [form, image, button, rslider]
---

# screverb

**Category:** Effects
**Source File:** `examples/Effects/Reverbs/MultiReverb.csd`
**Cabbage Widgets:** form, image, button, rslider

## Description

MultiReverb.csd Written by Iain McCurdy, 2012 Reverb effect that employs screverb and freeverb opcodes. Pitch Mod. is only used by reverbsc.
