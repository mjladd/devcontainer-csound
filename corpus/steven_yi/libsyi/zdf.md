...
- **Author:** Steven Yi
- **License:** MIT
- **Opcodes Defined:** zdf_1pole, zdf_high_shelf_eq, zdf_allpass_1pole, zdf_peak_eq, zdf_2pole_notch, zdf_low_shelf_eq, zdf_4pole_hp, zdf_4pole, zdf_ladder, zdf_2pole
- **Tags:** `udo`, `libsyi`, `steven-yi`, `zdf`

---

## Description

Zero Delay Feedback Filters  Based on code by Will Pirkle, presented in:
