...
- **Author:** Steven Yi
- **License:** MIT
- **Opcodes Defined:** k35_lpf, k35_hpf
- **Tags:** `udo`, `libsyi`, `steven-yi`, `k35`

---

## Description

12db/oct low-pass filter based on Korg 35 module (found in MS-10 and MS-20). 
