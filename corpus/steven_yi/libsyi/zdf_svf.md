# zdf_svf - Steven Yi's UDO Library
...
- **Author:** Steven Yi
- **License:** MIT
- **Opcodes Defined:** zdf_svf
- **Tags:** `udo`, `libsyi`, `steven-yi`, `zdf_svf`

---

## Description

Zero Delay State Variable Filter  Based on code by Will Pirkle, presented in:
