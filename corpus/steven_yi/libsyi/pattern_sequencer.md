# pattern_sequencer - Steven Yi's UDO Library
...
- **Author:** Steven Yi
- **License:** MIT
- **Opcodes Defined:** copy_pattern_measure, patternseq_seqsig, pattern_sequencer, copy_pattern_seq, set_pattern_seq
- **Tags:** `udo`, `libsyi`, `steven-yi`, `pattern_sequencer`
