...
- **Author:** Steven Yi
- **License:** MIT
- **Opcodes Defined:** diode_ladder
- **Tags:** `udo`, `libsyi`, `steven-yi`, `diode`

---

## Description

Diode Ladder Filter  Based on code by Will Pirkle, presented in:
