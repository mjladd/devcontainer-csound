# adsr140 - Steven Yi's UDO Library
...
- **Author:** Steven Yi
- **License:** MIT
- **Opcodes Defined:** adsr140_calc_coef, adsr140
- **Tags:** `udo`, `libsyi`, `steven-yi`, `adsr140`

---

## Description

Gated, Retriggerable Envelope Generator UDO (adsr140) Based on design of Doepfer A-140 Envelope Generator Module Code based on ADSR code by Nigel Redmon
