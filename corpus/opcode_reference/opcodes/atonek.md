...
url: https://csound.com/docs/manual/atonek.html
opcode: atonek
category: Signal Modifiers:Standard Filters:Control
description: "A hi-pass filter whose transfer functions are the complements of the [tonek](../opcodes/tonek.md) opcode...."
