...
file: csound_expression_wiki/Library-overview.md
category: Synthesis
concepts: [osc, envelope, filter, delay, sample, frequency, noise]
type: tutorial
---
...
**Category:** Synthesis
**Concepts:** osc, envelope, filter, delay, sample, frequency, noise
**Original File:** `csound_expression_wiki/Library-overview.md`

## Description

~~~ double :: Double -> D int    :: Int    -> D text   :: String -> Str sig    :: D -> Sig ~~~
