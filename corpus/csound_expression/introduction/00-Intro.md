...
title: "00-Intro"
file: tutorial/core/live/00-Intro.md
category: Introduction
concepts: [osc, sampler, midi]
type: tutorial
---
...
**Category:** Introduction
**Concepts:** osc, sampler, midi
**Original File:** `tutorial/core/live/00-Intro.md`

## Description

We are going to work with library `csound-core` and compiler `csound`. The Csound is an audio programming language. It's super powerful and great for our needs. It is a language and compiler.  The compiler converts Csound code to audio file or real-time performance. The csound is available on all platforms. Install Csound for your system. See the guide on the [csound site](https://csound.com/download.html).
