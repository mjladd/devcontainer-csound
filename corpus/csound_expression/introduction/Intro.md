...
title: "Intro"
file: tutorial/chapters/Intro.md
category: Introduction
concepts: [osc, granular, frequency]
type: tutorial
---
...
**Category:** Introduction
**Concepts:** osc, granular, frequency
**Original File:** `tutorial/chapters/Intro.md`

## Description

~~~ > cabal update > cabal install csound-expression --lib ~~~
