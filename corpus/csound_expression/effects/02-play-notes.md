...
title: "02-play-notes"
file: tutorial/core/live/02-play-notes.md
category: Effects
concepts: [delay, note]
type: tutorial
---
...
**Category:** Effects
**Concepts:** delay, note
**Original File:** `tutorial/core/live/02-play-notes.md`

## Description

In Csound we can trigger instruments with notes. A note has three components:
